...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
              ...
              and your last mission is to get neutron destruct bomb from
              the Weapons Armory, put it in the bridge, and blow the ship
              up after getting into an escape pod.

              You're runnig down Central Corridor to the Weapons
              Armory when a Gothon jumps out, red scaly skin, dark grimy
              teeth, and evil clown costuume flowing around his hate
              filled body.  He's blocking the door to the Armory and
              about to pull aweapon to blast you.
              """))
        ...
        if action == "shoot":
            print(dedent("""
                  ...
                  This completey ruins his brand new costume his mother
            ...
            print(dedent(""""
                  ...
                  slidde right as the Gothon's blaster cranks a laser
            ...
            print(dedent("""
                  ...
                  While he's laughing you run up and shoot him sqare in
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print(dedent("""
                  ...
                  together. You decide to sit here, and finally the
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
              ...
              take control of yoour ship.  Each of them has an even uglier
        ...
        if action == "throw the bomb":
            print(dedent("""
                  ...
                  Gothon shoots you in the back killing you.  As
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
              You  rush through ship desperately trying to make it to
        ...
        if int(guess) != good_pod:
            print(dedent(f"""
                  ...
                  implodes as hull ruptures, crushing your body into jam jelly.
                  """))
            return 'death'
        else:
            print(dedent(f"""
                  You ju,p into pod {guess} and hit the eject button.
